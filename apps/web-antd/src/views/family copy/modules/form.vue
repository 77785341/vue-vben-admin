 ...
 * @Date: 2026-03-20 13:58:00
 * @LastEditors: Felix 77785341@qq.com
 * @LastEditTime: 2026-03-20 13:58:00
...
import { createFamily, updateFamily } from '#/api/family/family';
...
const [Drawer, drawerApi] = useVbenDrawer({
  ...
  title: isUpdate.value
    ? $t('ui.actionTitle.edit', [$t('page.family.name')])
    : $t('ui.actionTitle.create', [$t('page.family.name')]),
});
</script>
