 ...
 * @LastEditTime: 2026-03-19 16:55:37
 * @FilePath: \vue-vben-admin\apps\web-antd\src\views\account\installer\modules\form.vue
 * @Description:
 *
...
import { createInstaller, updateInstaller } from '#/api/account/installer';
...
const [Drawer, drawerApi] = useVbenDrawer({
  ...
  title: isUpdate.value
    ? $t('ui.actionTitle.edit', [$t('system.installer.name')])
